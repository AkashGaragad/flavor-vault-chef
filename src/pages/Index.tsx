        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-10 py-16">
          ...
          <div className="rounded-xl border shadow-elegant overflow-hidden">
            <img
              ...
              height="400"
              loading="lazy"
              alt="Appetizing Mediterranean dish showcasing fresh ingredients"
          ...
          <Link to="/CalAI">
            <Card>
              <CardContent className="p-6 space-y-3">
                ...
                <h3 className="text-lg font-semibold">Check Food Calories</h3>
          ...
          <Link to="/recipes">
            <Card>
              <CardContent className="p-6 space-y-3">
                ...
                <p className="text-muted-foreground text-sm">
                  Rich recipe entries with photo, ingredients, steps, tags, and
                  difficulty.
                </p>
              </CardContent>
            </Card>
